...
public class main {
    public static void main(String[] args) {
        ...
        Divisa bitcoin = new Criptomonedas("Bitcoin", "BCN", 537.34, 1200D, "06/06/2006", 1);
        Divisa ethereum = new Criptomonedas("Ethereum", "ETH", 135.84, 800D, "06/06/2006", 2);
        Divisa cardano = new Criptomonedas("Cardano", "CAR", 227.15, 954D, "06/06/2006", 3);
